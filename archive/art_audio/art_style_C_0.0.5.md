...
- Non-pixel flat cel-shaded cozy sim look
- Terrain: Great Farm (Oddblot) when available
- Characters: outlined soft actors until sprites land in `assets/models/characters/`
